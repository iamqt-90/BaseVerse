...
export const Canvas: React.FC = () => {
  return (
    <section className="flex flex-col items-start px-9 py-9 mx-auto w-full text-base text-center bg-purple-300 rounded-3xl shadow-[0px_8px_32px_rgba(0,0,0,0.05)] max-md:px-5 max-md:mt-9 max-md:max-w-full">
      <ToolSelector />
      <div className="flex shrink-0 self-stretch mt-7 bg-violet-50 rounded-2xl h-[593px] max-md:max-w-full" />
      <div className="flex gap-5 mt-7 text-white">
        <Button>Save</Button>
